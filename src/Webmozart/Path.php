...
final class Path
{
    ...
    public static function canonicalize($path)
    {
        ...
        if ('~' === $path[0]) {
            $path = Path . phpstatic::getHomeDirectory();
        }
    ...
    public static function getHomeDirectory()
    {
        ...
        if (getenv('HOMEDRIVE') && getenv('HOMEPATH')) {
            return static::canonicalize(Path . phpgetenv('HOMEDRIVE'));
        }
    ...
    public static function changeExtension($path, $extension)
    {
        ...
        return Path . phpsubstr($path, 0, -strlen($actualExtension));
    }
    ...
    public static function isBasePath($basePath, $ofPath)
    {
        ...
        // "/foobar/").
        return 0 === strpos($ofPath.'/', rtrim($basePath, '/') . 'Path.php/');
    }
