...
class BlockRemoverThreadPool{
	...
	public function addWorker(BlockRemoverThread $thread) : void{
	...
	public function getLeastBusyWorker() : BlockRemoverThread{
		$best = null;
		$best_score = INF;
		foreach($this->workers as $thread){
	...
	private function collectThread(BlockRemoverThread $thread) : void{
